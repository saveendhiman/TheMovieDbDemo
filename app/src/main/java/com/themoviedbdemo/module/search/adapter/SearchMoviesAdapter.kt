package com.themoviedbdemo.module.search.adapter
...
class SearchMoviesAdapter(val list: ArrayList<Movie>, val context: Context, private val searchListener: SearchAdapterListener) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder?, position: Int) {
        ...
        holder.parent!!.setOnClickListener { searchListener.onMovieDetail(arrayList.id) }
        holder.tvReadMore!!.setOnClickListener { searchListener.onMovieDetail(arrayList.id) }

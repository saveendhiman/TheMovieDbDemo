package com.themoviedbdemo.module.top.adapter
...
class TopMoviesAdapter(val list: ArrayList<Movie>, val context: Context, private val topMovieListener: TopMovieAdapterListener) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder?, position: Int) {
        ...
        holder.parent!!.setOnClickListener { topMovieListener.onMovieDetail(arrayList.id) }
        holder.tvReadMore!!.setOnClickListener { topMovieListener.onMovieDetail(arrayList.id) }
    ...
    class TopMovieViewHolder(item: View) : RecyclerView.ViewHolder(item) {
